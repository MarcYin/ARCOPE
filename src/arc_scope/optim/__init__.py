...
quantum efficiency, prescribed thermal state, or energy-balance resistance
terms) against observed SIF, thermal, or flux data. ARC-retrieved
biophysical parameters are held fixed while the optimiser adjusts parameters
that cannot be retrieved from reflectance.
"""
