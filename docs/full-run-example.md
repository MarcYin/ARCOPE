...
!!! tip "Open the explorer in a new tab for the best experience"
    The interactive explorer is a standalone page that loads a 21 MB payload and renders Plotly charts.
    It works best in its own browser tab rather than embedded in this docs page.
